...
backend well-known-server
  mode http
  http-request return status 200 content-type "application/json" file "/well-known/server"
backend well-known-client
  mode http
  http-request return status 200 content-type "application/json" file "/well-known/client"
backend well-known-element
  mode http
  http-request return status 200 content-type "application/json" file "/well-known/element.json"
